...
// Flowbite react
import { Modal, Label, TextInput, Checkbox, Button, Textarea, Select } from "flowbite-react";
        ...
        <Modal.Body>
          <div className="space-y-6 px-6 pb-4 sm:pb-6 lg:px-8 xl:pb-8">
            ...
            <div>
              ...
              <Textarea
                id="description"
                rows={data.movie_description?.length > 0 ? data.movie_description.length / 10 : 1}
                type="text"
    ...
    <div className="bg-gray-900 min-h-screen text-white px-8 py-5">
      <div className="flex flex-wrap sm:space-x-4 space-y-4 sm:space-y-0 ">
        {moviesArray.map((item) => {
          return (
            <div key={item.movie_id} className="w-full sm:w-4/12  min-h-4/5 overflow-auto bg-blue-900 rounded-lg">
